...
class TestSquare_size(unittest.TestCase):
    ...
    def test_complex_size(self):
        with self.assertRaisesRegex(TypeError, "et({1, 2, 3, 1}))
...
class TestSquare_y(unittest.TestCase):
    ...
    def test_memoryview_y(peError, "width must be an integer"):
...
class TestSquare_update_args(unittest.TestCase):
    """Unittests for testing of update args method of the Square class."""
...
class TestSquare_update_kwargs(unittest.TestCase):
    ...
    def test_update_kwargs_x_negative(self):
        s = Square((size=5, id=89, a=1, b=54)
...
if __name__ == "__main__":
    unittest.main()width must be an integer"):
            Square(complex(5))
...
class TestSquare_order_of_initialization(unittest.TestCase):
    ...
    def test_size_before_y(self):
        with self.assertRaisesRegex(Ty   s.update(89, 2, 3, 4)
        s.update(4, 3, 2, 89)
