...
class Rectangle:
    ...
    def perimeter(self):
        '''method: perimeter
        returns perimeter of perimeter
        '''
    ...
    def __repr__(self):
        '''method: __repr__
        returns: representation of rectangle that can be used by eval() to
    ...
    def __del__(self):
        '''method: __del__
           deletes instance of Rectangle class, and prints the "bye" message
        '''
        Rectangle.number_of_instances -= 1
        print("Bye rectangle...")
